...
0x07/*bLength*/,0x05/*bDescrType=ENDPOINT*/,EPn_INPORT(EPIN)/*bEPAddr*/,0x03/*bmAttributes=Interrupt*/,EPn_MAX_PACKAGE_SIZE/*wMaxPacketSize*/,0x00/*bInterval*/,0x05/*bInterval*/};/*EndPoint Configuration Descriptor*/
