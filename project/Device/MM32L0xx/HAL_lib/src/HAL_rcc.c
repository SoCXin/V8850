...
#define CR_HSION_Reset            ((uint32_t)0xFFFFFFFE)
#define CR_HSION_Set              ((uint32_t)0x00000001)
#define CR_HSEBYP_Reset           ((uint32_t)0xFFFBFFFF)
#define CR_HSEBYP_Set             ((uint32_t)0x00040000)
#define CR_HSEON_Reset            ((uint32_t)0xFFFEFFFF)
#define CR_HSEON_Set              ((uint32_t)0x00010000)
#define CR_HSITRIM_Mask           ((uint32_t)0xFFFFC0FF)
#define CR_PLLON_Reset            ((uint32_t)0xFEFFFFFF)
#define CR_PLLON_Set              ((uint32_t)0x01000000)
...
#define CSR_LSION_Set              ((uint32_t)0x00000001)
#define CSR_LSION_Reset            ((uint32_t)0xFFFFFFFE)
...
void RCC_AdjustHSICalibrationValue(uint8_t HSICalibrationValue)
{
    ...
    tmpreg = RCC->CR;
    /* Clear HSICAL[5:0] bits */
    tmpreg &= CR_HSITRIM_Mask;
    /* Set the HSICAL[5:0] bits according to HSICalibrationValue value */
    tmpreg |= (uint32_t)((HSICalibrationValue&0x3f)<< 8);
    /* Store the new value */
    RCC->CR = tmpreg;
}
...
* @arg RCC_USBCLKSource_PLLCLK_Div2: PLL clock Div2 selected as USB clock source
* @arg RCC_USBCLKSource_PLLCLK_Div3: PLL clock Div3 selected as USB clock source
* @arg RCC_USBCLKSource_PLLCLK_Div4: PLL clock Div4 selected as USB clock source
* @retval : None
*/
...
*   RCC_APB2Periph_UART1, RCC_APB2Periph_COMP,
*   RCC_APB2Periph_TIM14, RCC_APB2Periph_TIM16,
*   RCC_APB2Periph_TIM17, RCC_APB2Periph_DBGMCU
*   RCC_APB2Periph_ALL
* @param NewState: new state of the specified peripheral clock.
*   This parameter can be: ENABLE or DISABLE.
* @retval : None
